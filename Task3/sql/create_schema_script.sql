...
(
    ...
    latitude  float8,
    longitude float8,
    constraint PK_location PRIMARY KEY (street_id),
    constraint UQ_location_street_id unique (street_id),
...
(
    ...
    constraint FK_crime_location foreign key (location_id) references "location" (street_id)
);
